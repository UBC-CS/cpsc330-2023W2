...
Every homework assignment will be made available on the [course GitHub page](https://github.com/UBC-CS/cpsc330-2023W2) under the `hw` folder. Once it's available, I'll make an announcement on [Piazza](https://piazza.com/class/lcgo6c2ncl06el). The assignment will generally consist of a jupyter notebook along with necessary code and data or links to download the data.    
